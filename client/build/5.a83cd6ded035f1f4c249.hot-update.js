...
function (_Component) {
  ...
  _createClass(Coins, [{
    ...
    value: function render() {
              ...
              filterCoin.filter(function (coin, index, arra) {
                arra.map(function (item, pos) {
                  ...
                  if (dataCoinsClean.length === index + 1) {
                    _this2.setState({
                      sortArray: dataCoinsClean
                    });

                    if (_this2.state.orderByPrice === false) {
                      _this2.state.sortArray.sort(function (a, b) {
      ...
      var coinsData = this.state.sort.map(function (coin) {
...
//# sourceMappingURL=5.a83cd6ded035f1f4c249.hot-update.js.map