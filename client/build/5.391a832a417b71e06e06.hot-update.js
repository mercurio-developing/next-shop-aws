    ...
    value: function render() {
      ...
      var coinsData = filterCoin.filter(function (coin, index, arra) {
        arra.map(function (item, pos) {
          ...
          if (item.id === coin.id && arra[pos] !== coin[index]) {} else if (item.id === coin.id && arra.indexOf(item[pos]) !== filterCoin.indexOf(coin[id])) {
...
//# sourceMappingURL=5.391a832a417b71e06e06.hot-update.js.map