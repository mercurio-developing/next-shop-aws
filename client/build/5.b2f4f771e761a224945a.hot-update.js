    ...
    value: function render() {
      ...
      var coinsData = filterCoin.filter(function (coin, index, arra) {
        arra.map(function (item, pos) {
          console.log(arra);
          console.log(arra.id, filterCoin.indexOf(coin));

          if (item.id === coin.id && arra[pos] === filterCoin.indexOf(coin)) {} else if (item.id === coin.id && arra.indexOf(item[pos]) !== filterCoin.indexOf(coin[id])) {
...
//# sourceMappingURL=5.b2f4f771e761a224945a.hot-update.js.map