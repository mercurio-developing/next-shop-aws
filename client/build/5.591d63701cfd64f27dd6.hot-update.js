...
function (_Component) {
  ...
  _createClass(cartPage, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react___default.a.Fragment, null, coinsData ? __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__components_cart_Cart__["a" /* default */], {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                console.log("rock");
                _context.next = 5;
                return __WEBPACK_IMPORTED_MODULE_3_axios___default.a.get("/api/coinsInCart");

              case 5:
                res = _context.sent;
                console.log(res.response.data);
                return _context.abrupt("return", {
                  coinsData: res.response.data
                });
...
//# sourceMappingURL=5.591d63701cfd64f27dd6.hot-update.js.map